...
#
#     from clidoc import metadata
#
# However, when we do this, we also import `clidoc/__init__.py'. If this
...
setup_dict = dict(
    ...
    # entry_points={
    #     'console_scripts': [
    #         'clidoc_cli = clidoc.main:entry_point'
    #     ],
    #     # if you have a gui, use this
    #     # 'gui_scripts': [
    #     #     'clidoc_gui = clidoc.gui:entry_point'
    #     # ]
    # }
)
